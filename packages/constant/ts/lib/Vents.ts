...
export const TheSkeldVentCoords: { [key in TheSkeldVent]: Vector2 } = {
    [TheSkeldVent.Admin]: {
        x: 2.543373,
        y: -9.59182
    },
...
export const MiraHQVentCoords: { [key in MiraHQVent]: Vector2 } = {
    [MiraHQVent.Balcony]: {
        x: 23.769283,
        y: -1.576561
    },
...
export const PolusVentCoords: { [key in PolusVent]: Vector2 } = {
    [PolusVent.Security]: {
        x: 1.9281311,
        y: 1.9281311
    },
