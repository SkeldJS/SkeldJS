...
import { UnreliablePacket } from "./UnreliablePacket";
...
describe("UnreliablePacket", () => {
    describe("UnreliablePacket#Deserialize", () => {
        it("Should deserialize an unreliable packet.", () => {
            ...
            const reader = HazelReader.from("12000546e43c8c0b0001050500f67b1186ff7fff7f", "hex");
            const packet = UnreliablePacket.Deserialize(reader, MessageDirection.Clientbound, decoder);
    ...
    describe("UnreliablePacket#Serialize", () => {
        it("Should serialize an unreliable packet.", () => {
            ...
            assert.strictEqual(writer.toString("hex"), "12000546e43c8c0b0001050300f67b1186ff7fff7f");
        });
    });
});
