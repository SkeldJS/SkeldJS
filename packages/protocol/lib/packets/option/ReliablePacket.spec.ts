...
import { ReliablePacket } from "./ReliablePacket";
...
describe("ReliablePacket", () => {
    describe("ReliablePacket#Deserialize", () => {
        it("Should deserialize a reliable packet.", () => {
            ...
            const reader = HazelReader.from("00020d000746e43c8c9a9e00009a9e00000006000a46e43c8c0100", "hex");
            const packet = ReliablePacket.Deserialize(reader, MessageDirection.Clientbound, decoder);
            ...
            assert.strictEqual(packet.children[0].tag, RootMessageTag.JoinedGame);
            assert.strictEqual(packet.children[1].tag, RootMessageTag.AlterGame);
        });
    });
    ...
    describe("ReliablePacket#Serialize", () => {
        it("Should serialize a reliable packet.", () => {
            ...
            const packet = new ReliablePacket(
                32,
                [
            ...
            assert.strictEqual(writer.toString("hex"), "00200d000746e43c8c9a9e00009a9e00000006000a46e43c8c0100");
        });
    });
});
