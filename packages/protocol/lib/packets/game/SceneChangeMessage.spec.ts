...
describe("SceneChangeMessage", () => {
    ...
    describe("SceneChangeMessage#Serialize", () => {
        it("Should serialize an rpc game data message.", () => {
            ...
            assert.strictEqual(writer.toString("hex"), "84cc020a4f6e6c696e6547616d65");
        });
    });
});
