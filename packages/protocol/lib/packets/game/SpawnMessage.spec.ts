...
describe("SpawnMessage", () => {
    describe("SpawnMessage#Deserialize", () => {
        it("Should deserialize a spawn game data message.", () => {
            const reader = HazelReader.from("0484cc02010307020001010108000001090a00010000ff7fff7fff7fff7f", "hex");
    ...
    describe("SpawnMessage#Serialize", () => {
        it("Should serialize a spawn game data message.", () => {
            ...
            assert.strictEqual(writer.toString("hex"), "0484cc02010307020001010108000001090a00010000ff7fff7fff7fff7f");
        });
    });
});
