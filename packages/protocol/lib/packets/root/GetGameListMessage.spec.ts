import { GameKeyword, GameMap, QuickChatMode, RootMessageTag } from "@skeldjs/constant";
import { HazelReader, HazelWriter } from "@skeldjs/util";
import assert from "assert";
import { GameListing, GameOptions } from "../../misc";
import { MessageDirection } from "../../PacketDecoder";

import { GetGameListMessage } from "./GetGameListMessage";
...
describe("GetGameListMessage", () => {
    describe("GetGameListMessage#Deserialize", () => {
        it("Should deserialize a client-bound get game list root message.", () => {
            const reader = HazelReader.from("0c00010500000002000000400000001a0000170000ae7f721e9857895ab78c06506f6f6b656504a10400020a", "hex");
            const packet = GetGameListMessage.Deserialize(reader, MessageDirection.Clientbound);
        ...
        it("Should deserialize a server-bound get game list root message.", () => {
            const reader = HazelReader.from("022e040a00010000000000803f0000803f0000c03f000034420101020100000002010f00000078000000000f0101000001", "hex");
            const packet = GetGameListMessage.Deserialize(reader, MessageDirection.Serverbound);
    ...
    describe("GetGameListMessage#Serialize", () => {
        it("Should serialize a client-bound get game list root message.", () => {
            ...
            assert.strictEqual(writer.toString("hex"), "0c00010500000002000000400000001a0000170000ae7f721e9857895ab78c06506f6f6b656504a10400020a");
        });
        ...
        it("Should serialize a server-bound get game list root message.", () => {
            ...
            assert.strictEqual(writer.toString("hex"), "022e040a00010000000000803f0000803f0000c03f000034420101020100000002010f00000078000000000f0101000001");
        });
    });
});
