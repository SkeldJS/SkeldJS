...
import { RemovePlayerMessage } from "./RemovePlayerMessage";
...
describe("RemovePlayerMessage", () => {
    describe("RemovePlayerMessage#Deserialize", () => {
        it("Should deserialize a client-bound remove game root message.", () => {
            const reader = HazelReader.from("40f8778cd48d0000728d000000", "hex");
            const packet = RemovePlayerMessage.Deserialize(reader, MessageDirection.Clientbound);
        ...
        it("Should deserialize a server-bound remove game root message.", () => {
            ...
            const packet = RemovePlayerMessage.Deserialize(reader, MessageDirection.Serverbound);
    ...
    describe("RemovePlayerMessage#Serialize", () => {
        it("Should serialize a client-bound redirect root message.", () => {
            ...
            assert.strictEqual(writer.toString("hex"), "40f8778cd48d0000728d000000");
        });
