...
import { ReportPlayerMessage } from "./ReportPlayerMessage";
...
describe("ReportPlayerMessage", () => {
    describe("ReportPlayerMessage#Deserialize", () => {
        it("Should deserialize a client-bound report player root message.", () => {
            ...
            const packet = ReportPlayerMessage.Deserialize(reader, MessageDirection.Clientbound);

            assert.strictEqual(packet.tag, RootMessageTag.ReportPlayer);
        ...
        it("Should deserialize a server-bound report player root message", () => {
            ...
            const packet = ReportPlayerMessage.Deserialize(reader, MessageDirection.Serverbound);
