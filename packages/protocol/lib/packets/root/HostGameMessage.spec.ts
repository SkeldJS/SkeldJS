...
import { HostGameMessage } from "./HostGameMessage";
...
describe("HostGameMessage", () => {
    describe("HostGameMessage#Deserialize", () => {
        it("Should deserialize a client-bound host game root message.", () => {
            ...
            const packet = HostGameMessage.Deserialize(reader, MessageDirection.Clientbound);
        ...
        it("Should deserialize a server-bound host game root message.", () => {
            const reader = HazelReader.from("2a020a01000000000000803f0000803f0000c03f000034420101020100000002010f00000078000000000f02", "hex");
            const packet = HostGameMessage.Deserialize(reader, MessageDirection.Serverbound);
