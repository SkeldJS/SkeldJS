...
import { GameDataMessage } from "./GameDataMessage";
...
describe("GameDataMessage", () => {
    describe("GameDataMessage#Deserialize", () => {
        it("Should deserialize a alter game root message.", () => {
            ...
            const reader = HazelReader.from("48daca8c21000403feffffff0f00025e1000010100076861696c657920076d020000005f010001001e000404e9ad02010360020001000061000001620a00010100c27ab286ff7fff7f0c000402feffffff0f000163000001", "hex");
            const packet = GameDataMessage.Deserialize(reader, MessageDirection.Clientbound, decoder);
            ...
            assert.deepStrictEqual(packet.children.map(child => child.tag), [
    ...
    describe("GameDataMessage#Serialize", () => {
        it("Should serialize a alter game root message.", () => {
            ...
            const packet = new GameDataMessage(
                "GITWMF",
                [
            ...
            assert.strictEqual(writer.toString("hex"), "48daca8c000004000004000004");
        });
    });
});
