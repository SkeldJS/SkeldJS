...
export type HideNSeekDeathFlowLogicComponentEvents = ExtractEventTypes<[]>;

export class HideNSeekDeathFlowLogicComponent<RoomType extends Hostable = Hostable> extends GameLogicComponent<HideNSeekDeathFlowLogicComponentEvents, RoomType> {
