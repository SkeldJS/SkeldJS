...
import { SetPetMessage } from "@skeldjs/au-protocol";
 ...
 */
export class PlayerSetPetEvent<RoomType extends StatefulRoom> extends BasicEvent implements PlayerEvent<RoomType>, ProtocolEvent {
