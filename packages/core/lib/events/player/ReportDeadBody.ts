...
import { ReportDeadBodyMessage } from "@skeldjs/au-protocol";
 ...
 * host or not.
 */
export class PlayerReportDeadBodyEvent<RoomType extends StatefulRoom> extends CancelableEvent implements PlayerEvent<RoomType>, ProtocolEvent {
