...
import { SetVisorMessage } from "@skeldjs/au-protocol";
 ...
 */
export class PlayerSetVisorEvent<RoomType extends StatefulRoom> extends BasicEvent implements PlayerEvent<RoomType>, ProtocolEvent {
