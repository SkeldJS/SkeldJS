...
import { SetHatMessage } from "@skeldjs/au-protocol";
 ...
 */
export class PlayerSetHatEvent<RoomType extends StatefulRoom> extends BasicEvent implements PlayerEvent<RoomType>, ProtocolEvent {
