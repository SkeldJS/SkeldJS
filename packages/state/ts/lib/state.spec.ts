...
describe("SkeldjsStateManager", () => {
    describe("#handleMessage", () => {
        it("Should handle a raw data buffer, deserialise and update state accordingly.", async () => {
            ...
            await state.handleInboundMessage(Buffer.from("0100010400007338818c", "hex"));

            assert.strictEqual(state.code, -1937688461);

            await state.handleInboundMessage(Buffer.from("0100020d00077338818c74060000740600000006000a7338818c0100", "hex"));
